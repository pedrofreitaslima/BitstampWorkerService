...
public class ConsumerStreamingEthUsd : IConsumeStreaming
{
    private readonly ILogger<Worker> _logger;

    public ConsumerStreamingEthUsd(ILogger<Worker> logger)
    {
        _logger = logger;
    }
    ...
    {
        _logger.LogInformation("Subscribe in: {channelName}", channelName);
